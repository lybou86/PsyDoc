...
SELECT
  (SELECT TOP 1 [Identity] from TypeDocument where Nom = 'Note dՎvolution')  AS TypeDocumentId,
  (SELECT TOP 1 [Identity] from TypeSection where Nom = 'Recommandations') AS TypeSectionId
