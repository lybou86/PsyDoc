...
GO
ALTER TABLE [dbo].[Seance] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[TypeDocumentTypeSection] WITH NOCHECK
...
ALTER TABLE [dbo].[Seance] WITH CHECK CHECK CONSTRAINT [FK_dbo.Seance_dbo.Therapie_TherapieId];

ALTER TABLE [dbo].[Section] WITH CHECK CHECK CONSTRAINT [FK_dbo.Section_dbo.Document_DocumentId];

ALTER TABLE [dbo].[Section] WITH CHECK CHECK CONSTRAINT [FK_dbo.Section_dbo.TypeSection_TypeSectionId];

ALTER TABLE [dbo].[Therapie] WITH CHECK CHECK CONSTRAINT [FK_dbo.Therapie_dbo.Dossier_DossierId];

ALTER TABLE [dbo].[TypeDocumentTypeSection] WITH CHECK CHECK CONSTRAINT [FK_TypeDocumentTypeSection_TypeDocument];

ALTER TABLE [dbo].[TypeDocumentTypeSection] WITH CHECK CHECK CONSTRAINT [FK_TypeDocumentTypeSection_TypeSection];
