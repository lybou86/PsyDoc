...
IF NOT EXISTS(SELECT TOP 1 * from Utilisateur WHERE Courriel = 'admin@psydocs.ca') 
BEGIN
	INSERT INTO [dbo].[Utilisateur]
     ...
     VALUES (NEWID(),
			 ...
			 'Administrateur1',
			 '51455555551',
			 'administrateur@psydocs.ca1',
			 '50D3C2A5902424C6E42EC06AA3CE84AD1', -- Le mot de passe "psydocs" en MD5 Hash
			 1)  
END
GO
