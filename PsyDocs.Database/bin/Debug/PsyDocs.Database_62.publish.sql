...
SELECT
  (SELECT TOP 1 [Id] from TypeDocument where Nom = 'Note dՎvolution')  AS TypeDocumentId,
  (SELECT TOP 1 [Id] from TypeSection where Nom = 'Recommandations') AS TypeSectionId
WHERE  NOT EXISTS
               (SELECT 0
